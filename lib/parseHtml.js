			...
			switch (statement.type)
			{
				case "BlockStatement":
				{
					if (statement.program !== undefined)
					{
						...
						{
							thisObj.newProgram.push( Node.HBS_HELPER_START(statement) );
							
							// Handle any and all nested expressions
							parseHtml(thisObj, statement.program);
							
							thisObj.newProgram.push( Node.HBS_HELPER_END(statement) );
						}
						else
						{
				...
				case "CommentStatement":
				{
					...
					{
						thisObj.newProgram.push( Node.HBS_COMMENT_START(statement) );
						thisObj.newProgram.push( Node.TEXT(statement.value) );
						thisObj.newProgram.push( Node.HBS_COMMENT_END(statement) );
					}
					break;
				}
				...
				{
					thisObj.newProgram.push( Node.HBS_VARIABLE(statement) );
					break;
				}
				default:
				{
